...
jupyter:
  ...
  kernelspec:
    display_name: Python [conda env:quarto-python]
    language: python
    name: conda-env-quarto-python-py
---
...
![Horse Populations Plot](../results/horse_pops_plot.png)
...
![Horse Populations](../results/horse_pops_plot_largest_sd.png)
